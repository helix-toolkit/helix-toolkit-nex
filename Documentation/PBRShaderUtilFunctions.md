...
mat4 getInvView()
```
- **Description**: Retrieves the inverse of the view matrix, useful for transforming view space coordinates back to world coordinates.
- **Return Type**: `mat4`
...
vec2 getScreenSize()
```
- **Description**: Retrieves the dimensions of the screen or viewport.
- **Return Type**: `vec2`
...
```
- **Description**: Returns the origin point of the ray associated with the pointer ring.
- **Return Type**: `vec3`

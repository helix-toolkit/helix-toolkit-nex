...
mat4 getInvView()
```
- **Description**: Provides the inverse view matrix, allowing transformation from view space back to world coordinates.
- **Return Type**: `mat4`
...
```
- **Description**: Computes the view direction vector from the camera position to the fragment position.
- **Return Type**: `vec3`

...
mat4 getView()
```
- **Description**: Retrieves the view matrix used for transforming coordinates from world space to view space.
- **Return Type**: `mat4`
...
```
- **Description**: Blends the fragment color with the pointer ring color if the pointer ring is enabled and the fragment is within the ring.
- **Return Type**: `vec4`

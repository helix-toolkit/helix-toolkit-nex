...
```
- **Description**: Retrieves the view-projection matrix, which transforms coordinates from world space to clip space.
- **Return Type**: `mat4`
...
mat4 getView()
```
- **Description**: Retrieves the view matrix, which transforms coordinates from world space to view space.
- **Return Type**: `mat4`

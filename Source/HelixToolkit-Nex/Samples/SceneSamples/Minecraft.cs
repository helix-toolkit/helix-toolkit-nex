...
/// </remarks>
public static class MinecraftScene
{
    // -----------------------------------------------------------------------
    // World configuration constants
    // -----------------------------------------------------------------------
    public const int WorldSizeX = 32; // blocks along X
    public const int WorldSizeZ = 32; // blocks along Z
    public const int MaxTerrainHeight = 8; // maximum terrain height in blocks
    public const int MinTerrainHeight = 3; // minimum terrain base height
    ...
    public static void RegisterMaterials()
    {
        ...
        MaterialTypeRegistry.Register(
            ...
            material.albedo = mix(material.albedo, vec3(0.1, 0.6, 1.0), wave * 0.4);
    ...
    /// </summary>
    public static int[,] GenerateHeightMap(int sizeX, int sizeZ)
    {
    ...
    /// </summary>
    public static BlockType GetBlockType(int x, int y, int z, int terrainHeight, int[,] heightMap)
    {

...
internal sealed class App : Application
{
    ...
    protected override void Initialize()
    {
        ...
        _ctx.RecreateSwapchain(size.Width, size.Height);

        _demo = new TextureDemo(_ctx);
        _demo.Initialize(size.Width, size.Height);
    }

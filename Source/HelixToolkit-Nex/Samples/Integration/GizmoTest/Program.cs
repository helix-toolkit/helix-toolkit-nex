...
using var app = new GizmoApp();
app.Run();

internal sealed class GizmoApp : Application
{
    public override string Name => "Gizmo Test";
    private static readonly ILogger _logger = LogManager.Create<GizmoApp>();
    private HelixToolkit.Nex.Graphics.IContext? _ctx;
    private GizmoDemo? _demo;

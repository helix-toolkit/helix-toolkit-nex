...
using var app = new LinesApp();
app.Run();

internal sealed class LinesApp : Application
{
    public override string Name => "Line Rendering Demo";
    private static readonly ILogger _logger = LogManager.Create<LinesApp>();
    private HelixToolkit.Nex.Graphics.IContext? _ctx;
    private LinesDemo? _demo;

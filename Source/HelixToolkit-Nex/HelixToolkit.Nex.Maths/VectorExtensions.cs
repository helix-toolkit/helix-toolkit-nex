...
namespace HelixToolkit.Nex.Maths
{
    public static class VectorExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color3 ToColor3(this System.Numerics.Vector2 vector, float blue = 0f)
        {
            return new Color3(vector.X, vector.Y, blue);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color4 ToColor4(this System.Numerics.Vector2 vector, float blue = 0f, float alpha = 0f)
        {
            return new Color4(vector.X, vector.Y, blue, alpha);
        }
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RectangleF ToRectangleF(this System.Numerics.Vector2 vector)
        {
            return new RectangleF(0f, 0f, vector.X, vector.Y);
        }
        /// <summary>
        /// To the rectangle.
        /// </summary>
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Rectangle ToRectangle(this System.Numerics.Vector2 vector)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color3 ToColor3(this System.Numerics.Vector3 vector)
        {
            return new Color3(vector);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Color4 ToColor4(this System.Numerics.Vector3 vector, float alpha = 0f)
        {
            return new Color4(vector, alpha);
        }
        #endregion

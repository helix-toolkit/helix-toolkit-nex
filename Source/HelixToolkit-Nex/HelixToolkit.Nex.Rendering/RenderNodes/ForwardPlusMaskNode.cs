...
public sealed class ForwardPlusMaskNode : RenderNode
{
    private static readonly ILogger _logger = LogManager.Create<ForwardPlusMaskNode>();
    public override string Name => nameof(ForwardPlusMaskNode);
    ...
    protected override bool CanRender(in RenderResources res)
    {
        ...
        return context.Data.MeshDrawStreams.GetStreams(DrawStreamType.AlphaMask).HasAny();
    }

...
public static class MeshGeometryHelper
{
    ...
    /// Collection of Normal vectors.
    /// </returns>
    public static IList<Vector3> CalculateNormals(
    ...
    public static unsafe void NormalizeInPlace(Vector3Collection data)
    {
...
#pragma warning restore IDE0052
    ...
    public static IList<int> FindSharpEdges(this MeshGeometry3D mesh, float minimumAngle)
    {
        ...
        for (var i = 0; i < mesh.TriangleIndices.Count / 3; i++)
        {
            ...
            for (var j = 0; j < 3; j++)
            {
                ...
                if (
                    edgeNormals.TryGetValue(edgeKey, out var value)
    ...
    public static MeshGeometry3D NoSharedVertices(this MeshGeometry3D input)
    {
        ...
        Vector2Collection? tc =
            input.TextureCoordinates != null && input.TextureCoordinates.Count > 0 ? new() : null;
    ...
    /// The new cutted <see cref="MeshGeometry3D"/> by the plane.
    /// </returns>
    public static MeshGeometry3D Cut(
    ...
    )
    {
        ...
        var hasTextureCoordinates =
            cloneMesh.TextureCoordinates != null && cloneMesh.TextureCoordinates.Count > 0;
    ...
    /// </returns>
    public static IList<Vector3> GetContourSegments(
        this MeshGeometry3D mesh,
        Vector3 planeOrigin,
        Vector3 planeNormal
    )
    ...
    public static void RemoveIsolatedVertices(
        ...
        IList<int> triangles,
        IList<Vector2>? texture,
        IList<Vector3>? normals,
        out IList<Vector3> verticesOut,
        out IList<int> trianglesOut,
        out IList<Vector2>? textureOut,
        out IList<Vector3>? normalOut
    )
    {
        textureOut = null;
        normalOut = null;
        ...
        Debug.WriteLine(
            string.Format("NumVert:{0}; NumTriangle:{1};", vertices.Count, triangles.Count)
        );
